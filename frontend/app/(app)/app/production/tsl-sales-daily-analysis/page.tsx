  ...
  return (
    <div className="space-y-4 p-4">
      ...
      <p className="text-sm text-app-muted">
        ERP `_TSLInvoiceItem`·`_TSLSalesItem`·`_TSLBillItem` 조인. 업체일자(거래명세 일자) 구간으로 조회하며,{' '}
        <strong className="text-app-text">수출품(`SMExpKind` = 8009004)</strong> 라인만 반환합니다. 기본 기간은 이번 달
        1일부터 오늘까지입니다.
      </p>
